...
# Retrieve the RNA counts matrix
expression_matrix <- hnscc_seu[["RNA"]]@counts
...
Genes = expression_matrix[c("CXCL8", "FOSL1", "KLF6", "COL17A1", "INHBA", "ITGA3", "ITGA5", "ITGB4", "LAMA3", 
...
pdf(file="SingaporeProgeny.pdf", width=8, height=12)	#create a pdf file to save the heatmap
